...
export class AuthService {
 ...
 // Nome do cookie que armazena o token
  ...
  setAuthToken(token: string): void {
    ...
    this.cookieService.set(this.tokenCookieName, token, expires, '/', 'front-secretaria-desenvolvimento-rural-jatai-gxpa6ujfg.vercel.app', true, 'Strict');
  }

  removeAuthToken(): void {
    this.cookieService.delete(this.tokenCookieName, '/', 'front-secretaria-desenvolvimento-rural-jatai-gxpa6ujfg.vercel.app', true, 'Strict');
  }
}
